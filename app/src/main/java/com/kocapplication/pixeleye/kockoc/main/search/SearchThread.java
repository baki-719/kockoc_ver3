package com.kocapplication.pixeleye.kockoc.main.search;
...
public class SearchThread extends Thread {
    final static String TAG = "SearchThread";
    private String postURL = BasicValue.getInstance().getUrlHead() + "News/readNewsForSearchTag.jsp";
    ...
    public SearchThread(Handler handler, int boardNo,String keyword) {
        this(handler);
    ...
    public void run() {
        ...
        try {
            ...
            params.add(new BasicNameValuePair("searchTag", Keyword.mainStr));;
