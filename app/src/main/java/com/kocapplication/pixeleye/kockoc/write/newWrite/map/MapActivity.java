package com.kocapplication.pixeleye.kockoc.write.newWrite.map;
...
public class MapActivity extends BaseActivityWithoutNav
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        daumMap.setDaumMapApiKey(BasicValue.getInstance().getDAUM_MAP_APP_KEY());
        daumMap.setMapType(MapView.MapType.Standard);
    ...
    private class ItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Log.d(TAG, item.latitude+"/"+item.longitude);
