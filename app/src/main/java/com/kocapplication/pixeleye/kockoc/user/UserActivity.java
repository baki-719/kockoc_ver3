package com.kocapplication.pixeleye.kockoc.user;
...
import com.kocapplication.pixeleye.kockoc.model.Board;
...
//            }
    ...
    private class ProfileHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            courseCount.setText(data.getCourseCount() + ""); // 등록한 데이터카운트 올라가지 않음!
        }
    }
